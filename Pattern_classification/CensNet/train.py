...
parser.add_argument('--data_name', type=str, default='citeseer', help='Data name to run with')
...
parser.add_argument('--saved_name', type=str, default='sample_run_1.txt', help='The saved file name for one run')
...
if __name__ == '__main__':
    ...
    file_path = "/root/siton-data-zhangyajunData/pattern/Pattern_classification/CensNet/data/re" + args.saved_name
